CREATE TABLE [Shopping].[PriceHistory] (
    ...
    [ItemShoppingItemID] INT            NOT NULL,
    [StoreID]            INT            NULL,
    CONSTRAINT [PK_PriceHistory] PRIMARY KEY CLUSTERED ([PriceHistoryID] ASC),
    CONSTRAINT [FK_PriceHistory_ShoppingItems] FOREIGN KEY ([ItemShoppingItemID]) REFERENCES [Shopping].[ShoppingItems] ([ShoppingItemID]),
